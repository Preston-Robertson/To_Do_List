...
def admin_update(request: Request):
    """Select stable origin/main and reinstall requirements without restarting."""
    from ... import application as host
    from .updates import update_from_main
    ...
    ok, update_steps = update_from_main(host.REPO_DIR, env)
