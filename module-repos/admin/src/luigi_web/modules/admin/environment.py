...
PROTECTED_KEYS = frozenset({
    ...
    "LUIGI_WEB_RECURRENCE_OWNER",
    "LUIGI_WEB_MODULE_REPOSITORY_OWNERS",
    "LUIGI_WEB_MODULE_REPOSITORIES_FILE",
    "LUIGI_WEB_MAINTAINER_REVIEW_ENABLED",
    "LUIGI_WEB_RELEASE_ENABLED",
    "LUIGI_MAINTAINER_ARTIFACT_DIR",
    "LUIGI_MAINTAINER_SANDBOX_IMAGE",
    "LUIGI_MAINTAINER_PREVIEW_URL",
    "LUIGI_MAINTAINER_PREVIEW_STATE_DIR",
    "LUIGI_MAINTAINER_PREVIEW_GATEWAY_KEY",
    "LUIGI_MAINTAINER_REQUIRED_CHECKS",
...
KNOWN_KEYS: tuple[EnvKey, ...] = (
    ...
    EnvKey("LUIGI_WEB_LLM_API_KEY",            "GitHub token / API key", "For headless Copilot, use github_pat_, gho_, or ghu_ for an account with Copilot access; classic ghp_ PATs are unsupported. Blank uses an existing CLI login or keeps the current secret on save.", "LLM", is_secret=True),
