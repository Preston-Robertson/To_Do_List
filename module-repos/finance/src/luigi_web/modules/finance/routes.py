...
from ...auth import finance_is_configured, finance_lock_response, finance_unlock_response, require_auth, require_finance_auth
...
@router.get("/finance/records", response_class=HTMLResponse, dependencies=_AUTH)
